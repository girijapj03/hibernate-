package com.giri.mobile.entity;
...
@NamedQuery(name="updateBrandByPrice",query="update MobileEntity as mobile set mobile.price='23500.0'where mobile.color='Purple'")
@NamedQuery(name="deleteById",query="delete MobileEntity  mobile where mobile.id=2")
